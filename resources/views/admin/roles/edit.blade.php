...
<body class="bg-gray-100 p-10">
    ...
    <div class="bg-white p-6 rounded-xl shadow border max-w-lg">
        <form action="{{ route('admin.roles.update', $rol) }}" method="POST" class="space-y-4">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" id="caracteristica" name="caracteristica" value="{{ old('caracteristica', $rol->caracteristica) }}"
                       placeholder="cargo o trabajo que realiza"
