...
<body class="bg-gray-100 p-10">
    <h1 class="text-2xl font-bold mb-4">Registrar Nuevo Grupo (CU-006)</h1>
    ...
    <div class="bg-white p-6 rounded-xl shadow border max-w-lg">
        <form action="{{ route('coordinador.grupos.store') }}" method="POST" class="space-y-4">
            @csrf
            <div>
            ...
            <div class="flex gap-4 pt-4">
                <button type="submit" class="rounded-lg bg-indigo-600 text-white px-4 py-2 hover:bg-indigo-700">Guardar Grupo</button>
